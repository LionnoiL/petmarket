...
public interface AdvertisementRepository extends AdvertisementRepositoryBasic {
    ...
    Page<Advertisement> findTop1000ByCategoryInOrderByCreatedDesc(
        List<AdvertisementCategory> categories, Pageable pageable);

    Page<Advertisement> findTop1000ByOrderByCreatedDesc(Pageable pageable);
}
